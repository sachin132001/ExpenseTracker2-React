  ...
  const[tdate,setTdate]=useState('')
    ...
    useEffect(() => {
      const fetchCategory = async () => {
        try {
          const response = await axios.get(`http://localhost:8080/Tupdate/${id}`);
          console.log(response.data)
          const {  tdate,tcat,particulars,amount,tven,tpay,tdetails,remarks } = response.data;
          setTdate(tdate);
          setTcat(tcat);
    ...
    const handleSubmit=async(event)=>{
      ...
      try{
        const response=await axios.post(`http://localhost:8080/Tupdate/${id}`,{
          tdate,
          tcat,
          particulars,
          amount,
  ...
  return (
    ...
    <div className="container mt-3">
		...
		<div className="col-md-4 jumbotron">
			...
			<h4 className="text-center bg-primary text-white">UPDATE TRANSACTION</h4> 
		<br></br>
                ...
                <textarea className="form-control"
                 ...
                 required></textarea>
		              ...
		              <div className="mb-3">
		                 ...
		                 <button className="btn btn-primary" type="submit">UPDATE Transaction</button>
